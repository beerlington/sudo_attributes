...
SudoAttributes adds a few class methods to your models:
...
SudoAttributes adds the following instance methods to any model that calls either @sudo_attr_protected@ or @sudo_attr_accessible@
